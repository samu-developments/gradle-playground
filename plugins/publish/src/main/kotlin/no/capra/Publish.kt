 ...
 */
open class Publish : Plugin<Project> {
    override fun apply(project: Project) {
        project.pluginManager.apply("maven-publish")
        project.extensions.create("publish", PublishExtension::class)
    }
}
...
open class PublishExtension(val project: Project) {
    /**
    ...
    fun conf(action: Action<PublishOptions>) {
        ...
        val options = PublishOptions().apply(action::execute)
